module.exports = {
  ...
  CODE_PAGE_PC437_USA             : Buffer.from([0x1b, 0x1d, 0x74, 0]),
  CODE_PAGE_KATAKANA              : Buffer.from([0x1b, 0x1d, 0x74, 1]),
  CODE_PAGE_PC850_MULTILINGUAL    : Buffer.from([0x1b, 0x1d, 0x74, 2]),
  CODE_PAGE_PC860_PORTUGUESE      : Buffer.from([0x1b, 0x1d, 0x74, 3]),
  CODE_PAGE_PC863_CANADIAN_FRENCH : Buffer.from([0x1b, 0x1d, 0x74, 4]),
  CODE_PAGE_PC865_NORDIC          : Buffer.from([0x1b, 0x1d, 0x74, 5]),
  CODE_PAGE_PC851_GREEK           : Buffer.from([0x1b, 0x1d, 0x74, 11]),
  CODE_PAGE_PC853_TURKISH         : Buffer.from([0x1b, 0x1d, 0x74, 12]),
  CODE_PAGE_PC857_TURKISH         : Buffer.from([0x1b, 0x1d, 0x74, 13]),
  CODE_PAGE_PC737_GREEK           : Buffer.from([0x1b, 0x1d, 0x74, 14]),
  CODE_PAGE_ISO8859_7_GREEK       : Buffer.from([0x1b, 0x1d, 0x74, 15]),
  CODE_PAGE_WPC1252               : Buffer.from([0x1b, 0x1d, 0x74, 16]),
  CODE_PAGE_PC866_CYRILLIC2       : Buffer.from([0x1b, 0x1d, 0x74, 17]),
  CODE_PAGE_PC852_LATIN2          : Buffer.from([0x1b, 0x1d, 0x74, 18]),
  CODE_PAGE_SLOVENIA              : Buffer.from([0x1b, 0x1d, 0x74, 18]),
  CODE_PAGE_PC858_EURO            : Buffer.from([0x1b, 0x1d, 0x74, 19]),
  CODE_PAGE_KU42_THAI             : Buffer.from([0x1b, 0x1d, 0x74, 20]),
  CODE_PAGE_TIS11_THAI            : Buffer.from([0x1b, 0x1d, 0x74, 21]),
  CODE_PAGE_TIS18_THAI            : Buffer.from([0x1b, 0x1d, 0x74, 26]),
  CODE_PAGE_TCVN3_VIETNAMESE_L    : Buffer.from([0x1b, 0x1d, 0x74, 30]),
  CODE_PAGE_TCVN3_VIETNAMESE_U    : Buffer.from([0x1b, 0x1d, 0x74, 31]),
  CODE_PAGE_PC720_ARABIC          : Buffer.from([0x1b, 0x1d, 0x74, 32]),
  CODE_PAGE_WPC775_BALTIC_RIM     : Buffer.from([0x1b, 0x1d, 0x74, 33]),
  CODE_PAGE_PC855_CYRILLIC        : Buffer.from([0x1b, 0x1d, 0x74, 34]),
  CODE_PAGE_PC861_ICELANDIC       : Buffer.from([0x1b, 0x1d, 0x74, 35]),
  CODE_PAGE_PC862_HEBREW          : Buffer.from([0x1b, 0x1d, 0x74, 36]),
  CODE_PAGE_PC864_ARABIC          : Buffer.from([0x1b, 0x1d, 0x74, 37]),
  CODE_PAGE_PC869_GREEK           : Buffer.from([0x1b, 0x1d, 0x74, 38]),
  CODE_PAGE_ISO8859_2_LATIN2      : Buffer.from([0x1b, 0x1d, 0x74, 39]),
  CODE_PAGE_ISO8859_15_LATIN9     : Buffer.from([0x1b, 0x1d, 0x74, 40]),
  CODE_PAGE_PC1098_FARCI          : Buffer.from([0x1b, 0x1d, 0x74, 41]),
  CODE_PAGE_PC1118_LITHUANIAN     : Buffer.from([0x1b, 0x1d, 0x74, 42]),
  CODE_PAGE_PC1119_LITHUANIAN     : Buffer.from([0x1b, 0x1d, 0x74, 43]),
  CODE_PAGE_PC1125_UKRANIAN       : Buffer.from([0x1b, 0x1d, 0x74, 44]),
  CODE_PAGE_WPC1250_LATIN2        : Buffer.from([0x1b, 0x1d, 0x74, 45]),
  CODE_PAGE_WPC1251_CYRILLIC      : Buffer.from([0x1b, 0x1d, 0x74, 46]),
  CODE_PAGE_WPC1253_GREEK         : Buffer.from([0x1b, 0x1d, 0x74, 47]),
  CODE_PAGE_WPC1254_TURKISH       : Buffer.from([0x1b, 0x1d, 0x74, 48]),
  CODE_PAGE_WPC1255_HEBREW        : Buffer.from([0x1b, 0x1d, 0x74, 49]),
  CODE_PAGE_WPC1256_ARABIC        : Buffer.from([0x1b, 0x1d, 0x74, 50]),
  CODE_PAGE_WPC1257_BALTIC_RIM    : Buffer.from([0x1b, 0x1d, 0x74, 51]),
  CODE_PAGE_WPC1258_VIETNAMESE    : Buffer.from([0x1b, 0x1d, 0x74, 52]),
  CODE_PAGE_KZ1048_KAZAKHSTAN     : Buffer.from([0x1b, 0x1d, 0x74, 53]),
